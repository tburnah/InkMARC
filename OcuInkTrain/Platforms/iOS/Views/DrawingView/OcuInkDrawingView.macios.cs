...
public partial class OcuInkDrawingView : PlatformTouchGraphicsView
{
    ...
    private OcuInkPoint OcuInkPointFromTouch(NSSet touches)
    {
        ...
        var point = new OcuInkPoint(location, (float)pressure, (float)tiltX, (float)tiltY, (ulong)timestamp);
        return point;
    }
    ...
    public override void TouchesBegan(NSSet touches, UIEvent? evt)
    {
        ...
        OcuInkPoint point = OcuInkPointFromTouch(touches);
        OnStart(point);
    }
