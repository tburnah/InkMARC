...
public partial class OcuInkDrawingView : PlatformTouchGraphicsView
{
	/// <summary>
	/// Initialize a new instance of <see cref="OcuInkDrawingView" />.
	/// </summary>
	...
	static ObservableCollection<OcuInkPoint> CreateCollectionWithNormalizedPoints(in ObservableCollection<OcuInkPoint> points, in int drawingViewWidth, in int drawingViewHeight, in float canvasScale)
	{
