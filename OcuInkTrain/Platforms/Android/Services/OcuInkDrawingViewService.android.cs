...
public static class OcuInkDrawingViewService
{
	...
	static Bitmap? GetBitmapForPoints(ICollection<OcuInkPoint> points,
		float lineWidth,
		Color strokeColor,
		Paint? background)
	{
...
#pragma warning restore CS8604 // Possible null reference argument.
	...
	static (Bitmap?, SizeF offset) GetBitmap(ICollection<OcuInkPoint> points, float maxLineWidth)
	{
	...
	static void DrawStrokes(Canvas canvas, ICollection<OcuInkPoint> points, float lineWidth, Color strokeColor, SizeF offset)
	{
