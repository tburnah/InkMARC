...
{
    /// <summary>
    /// Represents a OcuInk drawing view.
    /// </summary>
    public interface IOcuInkDrawingView : IView, IElement, ITransform
    {
        /// <summary>
        ...
        void OnDrawingLineStarted(OcuInkPoint point);
        ...
        /// </summary>
        /// <param name="point">Last drawing point</param>
        void OnPointDrawn(OcuInkPoint point);
