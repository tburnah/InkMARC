...
/// </summary>
public class AdvancedDrawingView : View, IOcuInkDrawingView
{
    ...
    /// </summary>
    public event EventHandler<OcuInkDrawingLineStartedEventArgs> DrawingLineStarted
    {
        add => drawingViewEventManager.AddEventHandler(value);
        remove => drawingViewEventManager.RemoveEventHandler(value);
    }
    ...
    /// </summary>
    public event EventHandler<OcuInkPointDrawnEventArgs> PointDrawn
    {
        add => drawingViewEventManager.AddEventHandler(value);
        remove => drawingViewEventManager.RemoveEventHandler(value);
    }
    ...
    public static ValueTask<Stream> GetImageStream(IEnumerable<IAdvancedDrawingLine> lines,
        ...
        OcuInkDrawingViewService.GetImageStream(lines.ToList(), imageSize, background, token);
    ...
    public ValueTask<Stream> GetImageStream(double imageSizeWidth, double imageSizeHeight, CancellationToken token = default) =>
        OcuInkDrawingViewService.GetImageStream(Lines.ToList(), new Size(imageSizeWidth, imageSizeHeight), Background, token);
    ...
    {
        if (lastDrawingLine is OcuInkDrawingLine ocuInkDrawingLine)
            drawingViewEventManager.HandleEvent(this, new OcuInkDrawingLineCompletedEventArgs(ocuInkDrawingLine), nameof(DrawingLineCompleted));
    ...
    /// </summary>
    public void OnDrawingLineStarted(OcuInkPoint point)
    {
        drawingViewEventManager.HandleEvent(this, new OcuInkDrawingLineStartedEventArgs(point), nameof(DrawingLineStarted));
    ...
    /// </summary>
    public void OnPointDrawn(OcuInkPoint point)
    {
        drawingViewEventManager.HandleEvent(this, new OcuInkPointDrawnEventArgs(point), nameof(PointDrawn));
