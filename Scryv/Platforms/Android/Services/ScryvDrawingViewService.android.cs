...
public static class ScryvDrawingViewService
{
	...
	static Bitmap? GetBitmapForPoints(ICollection<ScryvInkPoint> points,
		float lineWidth,
		Color strokeColor,
		Paint? background)
	{
...
#pragma warning restore CS8604 // Possible null reference argument.
	...
	static (Bitmap?, SizeF offset) GetBitmap(ICollection<ScryvInkPoint> points, float maxLineWidth)
	{
	...
	static void DrawStrokes(Canvas canvas, ICollection<ScryvInkPoint> points, float lineWidth, Color strokeColor, SizeF offset)
	{
