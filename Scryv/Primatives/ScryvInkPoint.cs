namespace Scryv.Primatives
{
    ...
    public struct ScryvInkPoint
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScryvInkPoint"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScryvInkPoint"/> struct with the specified parameters.
        /// </summary>
