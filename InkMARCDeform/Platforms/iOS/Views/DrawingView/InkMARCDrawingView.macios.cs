...
public partial class InkMARCDrawingView : PlatformTouchGraphicsView
{
    ...
    private InkMARCPoint InkMARCPointFromTouch(NSSet touches)
    {
        ...
        var point = new InkMARCPoint(location, (float)pressure, (float)tiltX, (float)tiltY, (ulong)timestamp);
        return point;
    }
    ...
    public override void TouchesBegan(NSSet touches, UIEvent? evt)
    {
        ...
        InkMARCPoint point = InkMARCPointFromTouch(touches);
        OnStart(point);
    }
